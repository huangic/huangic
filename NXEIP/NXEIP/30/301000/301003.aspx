<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="301003.aspx.cs" Inherits="_30_301000_301003" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <uc1:Navigator ID="Navigator1" runat="server" SysFuncNo="301003" />
    <div class="PersonalCalendarLayout">
        <div class="tabHeader-bigmonth1">
            <div class="select-s">
                ...
                <div class="b3">
                    <li class="p1"><span class="a-letter-ss">設備</span></li>
                </div>
                <div class="b2">
                    <asp:DropDownList ID="ddl_equ" runat="server" CssClass="select4" 
                        AutoPostBack="True" onselectedindexchanged="ddl_equ_SelectedIndexChanged">
                    </asp:DropDownList>
                </div>
                <div class="b4">
                    <div class="tabHead_big">
                        <ul>
                            ...
                            <li>
                                <asp:HyperLink ID="hl_weeks" runat="server" NavigateUrl="301003-1.aspx">周</asp:HyperLink>
                            </li>
                        </ul>
                    </div>
                </div>
