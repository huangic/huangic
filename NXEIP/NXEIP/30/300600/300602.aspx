            ...
            <ContentTemplate>
                <cc1:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="r01_peouid" HeaderText="單位" 
                            SortExpression="r01_peouid">
                            <ItemStyle Width="15%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="r01_peouid" HeaderText="管理者" 
                            SortExpression="r01_peouid">
                            <ItemStyle Width="15%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="r01_type" HeaderText="電子郵件通知" 
                            SortExpression="r01_type">
                            <ItemStyle Width="15%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="r01_type" HeaderText="e公務訊息通知" 
                            SortExpression="r01_type">
                            <ItemStyle Width="15%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="r01_type" HeaderText="訊息通知" 
                            SortExpression="r01_type">
                            <ItemStyle Width="15%" />
                        </asp:BoundField>
