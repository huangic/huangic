<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="300202-a.aspx.cs" Inherits="_30_300200_300202_a" %>
        ...
        <div>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="cas_answer" HeaderText="回答" SortExpression="cas_answer" />
                </Columns>
                <EmptyDataRowStyle Font-Bold="True" ForeColor="Red" HorizontalAlign="Center" />
            </asp:GridView>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:NXEIPConnectionString %>"
                SelectCommand="SELECT departments.dep_name, types.typ_cname, people.peo_name, botanize.bot_date, casework.cas_answer FROM casework INNER JOIN botanize ON casework.bot_no = botanize.bot_no INNER JOIN people ON botanize.peo_uid = people.peo_uid INNER JOIN departments ON people.dep_no = departments.dep_no INNER JOIN types ON people.peo_pfofess = types.typ_no WHERE (botanize.bot_status = '1') AND (casework.que_no = @que_no) AND (casework.the_no = @the_no) ORDER BY departments.dep_order, types.typ_order, people.peo_name">
                <SelectParameters>
                    <asp:QueryStringParameter Name="que_no" QueryStringField="que_no" />
                    <asp:QueryStringParameter Name="the_no" QueryStringField="the_no" />
                </SelectParameters>
            </asp:SqlDataSource>
            <div class="footer">
                <div class="f1">
