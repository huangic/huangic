...
var popUpCal = {
    ...
    drawCalendar: function(inputObj) {
        ...
        var html = '';
        html = '<a id="closeCalender">關閉月曆</a>'; //ORIGINAL: html = '<a id="closeCalender">Close Calendar</a>';
        html += '<table cellpadding="0" cellspacing="0" id="linksTable">';
        //html += '<tr><td width="50%" align="left"><a id="prevYear"><< 前一年</a></td><td width="50%" align="right"><a id="nextYear">下一年 >></a></td></tr>';
        html += '<tr>';
        html += '<td width="50%" align="left"><a id="prevMonth">< 前一個月</a></td>'; //ORIGINAL: html += '	<td><a id="prevMonth"><< Prev</a></td>';
        ...
        html += '<td align="center"><a id="ToDay">回至今天日期</a></td></tr></table>';
...
//            popUpCal.selectedYear--;
//            if (popUpCal.selectedYear < 1900) {
//                popUpCal.selectedYear = 1900;
//                popUpCal.selectedMonth = 0;
//            }
