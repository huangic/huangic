<%@ Page Language="C#" AutoEventWireup="true" CodeFile="200601-7.aspx.cs" Inherits="_20_200600_200601_5" %>
       ...
       <div class="talkn">
        <table class="back">
          <tbody>
            ...
            <tr>
              <td class="bg1_title" colspan="2">發表新主題</td>
              </tr>
             ...
             <tr>
              ...
              <td class="bg2">
                  <asp:Label ID="lab_forum" runat="server"></asp:Label>
                </td>
            </tr>
