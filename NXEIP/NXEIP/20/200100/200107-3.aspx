<%@ Page Language="C#" AutoEventWireup="true" CodeFile="200107-3.aspx.cs" Inherits="_20_200100_200107_3" EnableEventValidation="false" %>
...
<body>
    ...
    <uc2:Navigator ID="Navigator1" runat="server" SysFuncNo="200107" SubFunc="修改檔案" />
    
   <div class="tableDiv">
        <asp:HiddenField ID="hidden_d09no" runat="server" />
        <asp:ScriptManager ID="ScriptManager1" runat="server">
        </asp:ScriptManager>
        <asp:ObjectDataSource ID="ObjectDataSource_file" runat="server" 
            OldValuesParameterFormatString="original_{0}" SelectMethod="GetAllWithDoc09No" 
            TypeName="NXEIP.DAO.Doc10DAO">
            <SelectParameters>
                <asp:QueryStringParameter Name="doc09_no" QueryStringField="id" Type="Int32" />
            </SelectParameters>
                 ...
                 <tr>
                    ...
                    <td colspan="3">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:ListView ID="ListView1" runat="server" DataSourceID="ObjectDataSource_file" 
                            DataKeyNames="d09_no,d10_no" onitemcommand="ListView1_ItemCommand">
                            <ItemTemplate>
                                <li><asp:Label ID="Label3" runat="server" Text='<%# Eval("d10_file") %>'></asp:Label>
