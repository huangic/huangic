<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JQueryDepartTree.aspx.cs" Inherits="lib_tree_JQueryDepartTree" %>
    ...
    <asp:Panel ID="Panel1" runat="server"  CssClass="DepartView" Width="530px">
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
                <tr>
                    ...
                    <td bgcolor="#eeeeee" class="a-letter-2">
                        <div align="center">
                            <span class="a-letter-1">選取人員名單</span></div>
