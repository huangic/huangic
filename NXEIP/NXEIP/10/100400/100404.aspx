<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="100404.aspx.cs" Inherits="_10_100400_100404" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <uc1:Navigator ID="Navigator1" runat="server" SysFuncNo="100404" />
                        ...
                        <asp:TemplateField HeaderText="提交" ItemStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                <a id="btnShowPopup" runat="server" class="imageButton edit" title='修改'
                                    href='<%# Eval("f01_no", "100404-1.aspx?ID={0}") %>'>
                                    <span>提交</span>
                                </a>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="檢視" ItemStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                <a id="btnShowPopup" runat="server" class="thickbox imageButton peruse" title='檢視'
                                    href='<%# String.Format( "100404-2.aspx?modal=true&mode=edit&ID={0}&SID={1}&TB_iframe=true&height=600&width=600",Eval("Form.f01_no"),Eval("Submit.f02_no")) %>'>
                                    <span>修改</span>
                                </a>
                            </ItemTemplate>
