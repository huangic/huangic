...
public partial class _10_100300_100301_3 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            this.hl_Pre.NavigateUrl = localurl + "?today=" + changeobj.ADDTtoROCDT(Convert.ToDateTime(changeobj.ROCDTtoADDT(this.lab_date.Text)).AddYears(-1).ToString("yyyy-MM-01"));
            this.hl_Nxt.NavigateUrl = localurl + "?today=" + changeobj.ADDTtoROCDT(Convert.ToDateTime(changeobj.ROCDTtoADDT(this.lab_date.Text)).AddYears(1).ToString("yyyy-MM-01"));
            //今天日期
