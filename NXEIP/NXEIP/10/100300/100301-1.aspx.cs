...
public partial class _10_100300_100301_1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                qrydepart = Request["depart"];
                if (parem.Length > 0) parem += "&";
                parem += "depart=" + qrydepart;
            }
    ...
    private void Show()
    {
        ...
        try
        {
            ...
            #region 連結位址更換
            //日、週、月、年、列表
            this.HyperLink1.NavigateUrl = "100301.aspx?today=" + this.lab_date.Text + "&" + parem;
            this.current.NavigateUrl = "100301-1.aspx?today=" + this.lab_date.Text + "&" + parem;
            this.HyperLink3.NavigateUrl = "100301-2.aspx?today=" + this.lab_date.Text + "&" + parem;
            this.HyperLink4.NavigateUrl = "100301-3.aspx?today=" + this.lab_date.Text + "&" + parem;
            this.HyperLink5.NavigateUrl = "100301-4.aspx?today=" + this.lab_date.Text + "&" + parem;
            //上一個月、下一個月(箭頭)
            ...
            string ax = "100";
            string ay = "100";
            string script = "newwindow=window.open('100301-p.aspx?today=" + this.lab_date.Text + "&peo_uid=" + this.lab_people.Text + "&printtype=weeks','new_wealthy_calendar','height=580,width=700,toolbar=0,location=0,directories=0,status=0,menubar=1,scrollbars=1,resizable=1');newwindow.focus();newwindow.moveTo(" + ax + "," + ay + ")";
