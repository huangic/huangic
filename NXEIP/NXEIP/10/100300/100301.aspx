        ...
        <div class="left">
            ...
            <div class="border-bottom-block">
                <span class="icon a-letter-1">新增行事曆<br />
                    ...
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;行程日期
                    <uc2:calendar ID="cal_date" runat="server" _Show="False" />
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;事件時間
            ...
            <asp:Panel ID="Panel1" runat="server" CssClass="border-bottom-block">
                ...
                <asp:Button ID="btn_QrySubmit" runat="server" CssClass="b-input" Text="搜尋" />
            </asp:Panel>
            <div class="border-bottom-block">
            ...
            <div class="layoutDiv">
                ...
                <asp:Table ID="Table1" runat="server" CssClass="big-calendar-time">
                    <asp:TableRow runat="server" TableSection="TableHeader">
                        <asp:TableCell runat="server" CssClass="title_time">時間</asp:TableCell>
                        <asp:TableCell runat="server" CssClass="title_schedule">行程</asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
                <div class="footer">
                    <div class="f1">
