...
public partial class _10_100300_100301_2 : System.Web.UI.Page
{
    ...
    protected void btn_print_Click(object sender, EventArgs e)
    {
        string ax = "100";
        string ay = "100";
        string script = "<script>newwindow=window.open('100301-p.aspx?today=" + this.lab_date.Text + "&peo_uid=" + this.lab_people.Text + "&printtype=months','new_wealthy_calendar','height=580,width=700,toolbar=0,location=0,directories=0,status=0,menubar=1,scrollbars=1,resizable=1');newwindow.focus();newwindow.moveTo(" + ax + "," + ay + ")</script>";
