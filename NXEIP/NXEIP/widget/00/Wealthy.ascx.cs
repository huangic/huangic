...
public partial class widget_00_Wealthy : NXEIP.Widget.WidgetBaseControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //簽核資料WebService
        Wealthy_WebReference.PeopleSign sign = new Wealthy_WebReference.PeopleSign();
        ...
        //今日代理人件數WebService
        Wealthy2_WebReference.peopleAgent peoAgent = new Wealthy2_WebReference.peopleAgent();
        ...
        //本日刷卡紀錄WebService
        Wealthy3_WebReference.CardLog cardlog = new Wealthy3_WebReference.CardLog();
