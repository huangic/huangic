...
function chooseDept(form1code,form1name,deptcode,deptname){
 	form1code.value = deptcode;
 	form1name.value = deptname;
 	self.close();
 }
...
function gFld(formcode,formname, description, linkData)
{
  var description2="<font style=font-size:9pt; font-color: #00ff00;background-color:#ccff99>" + description
  if (linkData=="") {
    fullLink=""
  } else {
    fullLink = "'javascript:chooseDept(opener."+formcode+",opener."+formname+",\""+linkData+"\",\""+description+"\")'"
  }
  folder = new Folder(description2, fullLink)
  return folder
}

function gLnk(formcode,formname, description, linkData)
{
  var description2="<font style=font-size:9pt; font-color: #0000ff;background-color:#ccff99>" + description
  if (linkData=="") {
    fullLink=""
  } else {
    fullLink = "'javascript:chooseDept(opener."+formcode+",opener."+formname+",\""+linkData+"\",\""+description+"\")'"
  }
  linkItem = new Item(description2, fullLink)
  return linkItem
}
