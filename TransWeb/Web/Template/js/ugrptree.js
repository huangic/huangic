...
function gLnk(target, description,nodevalue,checkstatus, linkData)
{
  
  if(checkstatus == 'true' ){
  	description="<font style=font-size:9pt; font-color: #0000ff;background-color:#ccff99><input type='checkbox' name='ugrp' value='"+nodevalue+"' checked='"+checkstatus+"'/>" + description
  }else{
    description="<font style=font-size:9pt; font-color: #0000ff;background-color:#ccff99><input type='checkbox' name='ugrp' value='"+nodevalue+"'/>" + description
  }
  if (linkData=="") {
    fullLink=""
  } else {
