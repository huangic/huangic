...
public partial class _30_300300_300303 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            if (Request["sdate"] != null && Request["edate"] != null)
            {
                ...
                this.LoadData(sdate, edate, Request["type_1"], Request["type_2"], Request["e02_place"], Request["e02_name"], new SessionObject().sessionUserID, Request["pageIndex"]);
            }
            else
            {
                this.LoadData(DateTime.Now.ToString("yyyy-MM-dd"), "", this.ddl_type_1.SelectedValue, this.ddl_type_2.SelectedValue, this.tbox_place.Text.Trim(), this.tbox_name.Text, new SessionObject().sessionUserID, "0");
            }
    ...
    protected void btn_ok_Click(object sender, EventArgs e)
    {
        if (this.CheckUI())
        {
            this.LoadData(this.calendar1._ADDate.ToString("yyyy-MM-dd"), this.calendar2._ADDate.ToString("yyyy-MM-dd"),this.ddl_type_1.SelectedValue,this.ddl_type_2.SelectedValue,this.tbox_place.Text.Trim(),this.tbox_name.Text,new SessionObject().sessionUserID,"0");
        }
    }
    ...
    /// 撈資料
    /// </summary>
    private void LoadData(string sdate, string edate, string type_1, string type_2, string e02_place, string e02_name, string openuid, string pageIndex)
    {
        ...
        this.ODS_1.SelectParameters["e02_place"].DefaultValue = e02_place;
