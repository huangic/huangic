<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="300402.aspx.cs" Inherits="_30_300400_300402" EnableEventValidation="false" %>
...
<%@ Register Src="../../lib/tree/DepartTreeTextBox.ascx" TagName="DepartTreeTextBox"
    TagPrefix="uc3" %>
<%@ Register Src="../../lib/tree/DepartTreeListBox.ascx" TagName="DepartTreeListBox"
    TagPrefix="uc4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Label ID="lab_no" runat="server" Visible="False"></asp:Label><asp:Label ID="lab_mode" runat="server"
        Visible="False"></asp:Label><asp:Label ID="lab_pageIndex" runat="server" Visible="False"></asp:Label>
    <asp:Label ID="lab_outxt" runat="server"></asp:Label>
    <uc1:Navigator ID="Navigator1" runat="server" SysFuncNo="300402" />
    <asp:Panel ID="ViewList" runat="server">
        <div class="tableDiv">
            <div class="header">
                <div class="h1">
                </div>
    ...
    <asp:Panel ID="ViewModify" runat="server">
        <div class="tableDiv">
            <div class="header">
                <div class="h1">
                </div>
