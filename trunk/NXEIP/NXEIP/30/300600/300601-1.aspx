<%@ Page Language="C#" AutoEventWireup="true" CodeFile="300601-1.aspx.cs" Inherits="_30_300600_300601_1" %>
...
<body>
    ...
    <uc2:Navigator ID="Navigator1" runat="server" SubFunc="修改" SysFuncNo="300601" />
    <div class="tableDiv">
        <div class="header">
            <div class="h1">
            </div>
