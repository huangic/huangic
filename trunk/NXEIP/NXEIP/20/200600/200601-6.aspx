<%@ Page Language="C#" AutoEventWireup="true" CodeFile="200601-6.aspx.cs" Inherits="_20_200600_200601_5" %>
        ...
        <table class="back">
          <tbody>
            ...
            <tr>
              ...
              <td class="bg2">
                  <asp:TextBox ID="tb_subject" runat="server" MaxLength="50" ></asp:TextBox>
                </td>
            </tr>
