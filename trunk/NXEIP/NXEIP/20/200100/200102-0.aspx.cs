...
public partial class _20_200100_200102_0 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            new OperatesObject().ExecuteOperates(200102, sobj.sessionUserID, 2, "預約首長行程");
    ...
    protected void btn_submit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (this.Panel0.Visible)
            {
                ...
                if (this.lab_c03_no.Text.Trim().Length > 0)
                {
                    ...
                    //登入記錄(功能編號,人員編號,操作代碼[1新增 2查詢 3更新 4刪除 5保留],備註)
                    new OperatesObject().ExecuteOperates(200102, sobj.sessionUserID, 3, "預約首長行程--週期行程修改 peo_uid" + this.lab_peo_uid.Text + ",c03_no=" + c03_no);
                }
                else
                {
                    #region 新增
                    ...
                    //登入記錄(功能編號,人員編號,操作代碼[1新增 2查詢 3更新 4刪除 5保留],備註)
                    new OperatesObject().ExecuteOperates(200102, sobj.sessionUserID, 1, "預約首長行程--週期行程新增 peo_uid" + this.lab_peo_uid.Text + ",c03_no=" + c03_no);
                }
        ...
        {
            aMSG = "功能名稱:首長行程--確定新增或修改<br>錯誤訊息:" + ex.ToString();
            Response.Write(aMSG);
        }
    }
    #endregion
    ...
    private void InsertDB_C02(int c02_no, DateTime sdate, DateTime edate, int c03_no)
    {
        ...
        {
            aMSG = "功能名稱:首長行程-新增資料庫C02<br>錯誤訊息:" + ex.ToString();
            Response.Write(aMSG);
        }
    }
    #endregion
