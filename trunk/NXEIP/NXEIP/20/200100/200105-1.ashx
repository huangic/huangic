...
public class _200107_1 : IHttpHandler, IRequiresSessionState
{
   ...
   public void ProcessRequest(HttpContext context)
       ...
       int doc12_no = int.Parse(context.Request.QueryString["d12"]);
	        //讀取DB
	        using (NXEIPEntities model=new NXEIPEntities())
	        {
	          try{
                ...
                //取檔案資訊
                var file =(from d in model.doc12 where d.d11_no==doc11_no && d.d12_no==doc12_no select d).First();





                    string filename =file.d12_file;
                    ...
                    string fileabspath=path+file.d12_path;
                
                    if (string.IsNullOrEmpty(path))
                    {
                        fileabspath = context.Server.MapPath(file.d12_path);
                    }
