<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="100301-4.aspx.cs" Inherits="_10_100300_100301_4" EnableEventValidation="false" %>
            ...
            <div class="tabHeader">
                <div class="tabHead">
                    <ul>
                        ...
                        <li><asp:HyperLink ID="current" runat="server" NavigateUrl="100301-4.aspx">列表</asp:HyperLink></li>
                    </ul>
                </div>
            </div>
            <div class="block-1">
