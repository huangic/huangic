        ...
        if (!this.IsPostBack)
        {
            ...
            else
            {
                ...
                if (sorData != null)
                {
                    ...
                    this.lab_stime.Text = pet_etime.ToString("HH:00");
                    ...
                    this.ddl_hour.Items.FindByValue(sorData.pet_meeting.Value.ToString("HH"));
                    this.ddl_min.Items.FindByValue(sorData.pet_meeting.Value.ToString("ss"));
                    #endregion
                    ...
                    else
                    {
                        #region 本人
                        //是否過期
                        if (pet_etime < Convert.ToDateTime(System.DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss")))
                        {
                            this.btn_delete.Enabled = false;
                            this.btn_delete.Visible = false;
                        }
