<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="100405.aspx.cs" Inherits="_10_100400_100405" EnableEventValidation="false" %>
        ...
        <div class="left">
            <div class="block-1">
                ...
                <table class="calendar-place">
                            ...
                            <div class="select-L">
                                ...
                                <div class="bp2">
                                    ...
                                    <ajaxtoolkit:CascadingDropDown ID="ddl_spot_CascadingDropDown" runat="server" Category="spot"
                                        ...
                                        TargetControlID="ddl_spot" ServicePath="../../WebService/equborrow.asmx" 
                                        UseContextKey="True">
                                    </ajaxtoolkit:CascadingDropDown>
                                </div>
                            </div>
                            <div class="select-L">
                                <div class="bp1">設備</div>
                                <div class="bp2">
                                    <asp:DropDownList ID="ddl_equipments" runat="server" CssClass="select4" AutoPostBack="True"
                                        OnSelectedIndexChanged="ddl_equipments_SelectedIndexChanged">
                                    </asp:DropDownList>
                                    <ajaxtoolkit:CascadingDropDown ID="ddl_equipments_CascadingDropDown" runat="server" TargetControlID="ddl_equipments"
                                        Category="equipments" ContextKey="" LoadingText="讀取中..." ParentControlID="ddl_spot"
                                        PromptText="請選擇" PromptValue="0" ServiceMethod="GetEquipments" ServicePath="../../WebService/equborrow.asmx">
                                    </ajaxtoolkit:CascadingDropDown>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td class="place1_bg">所在地</td>
                        <td class="place2_bg"><asp:Label ID="lab_spot" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="place1_bg">資產編號</td>
                        <td class="place2_bg"><asp:Label ID="lab_number" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="place1_bg">設備名稱</td>
                        <td class="place2_bg"><asp:Label ID="lab_name" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="place1_bg">保管人</td>
                        <td class="place2_bg"><asp:Label ID="lab_peouid" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="place1_bg" style="width:120px">保管人電話</td>
                        <td class="place2_bg"><asp:Label ID="lab_tel" runat="server"></asp:Label><asp:Label ID="lab_ext" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="place1_bg">設備描述</td>
                        <td class="place2_bg"><asp:Label ID="lab_describe" runat="server"></asp:Label></td>
                    </tr>
                </table>
            </div>
        </div>
