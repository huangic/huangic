<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="100402.aspx.cs" Inherits="_10_100400_100402" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="PersonalCalendarLayout">
        <div class="left">
            <div class="block-1">
                <div class="header_place">請先選擇場所</div>
                <table class="calendar-place">
                    <tr>
                        <td colspan="2">
                            ...
                            <div class="select-L">
                                <div class="bp1">場地</div>
                                <div class="bp2">
                                    <asp:DropDownList ID="ddl_rooms" runat="server" CssClass="select4" AutoPostBack="True"
                    ...
                    <tr>
                        <td class="place1_bg">所在樓層</td>
                        <td class="place2_bg"><asp:Label ID="lab_floor" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="place1_bg">場地電話</td>
                        <td class="place2_bg"><asp:Label ID="lab_telephone" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="place1_bg">容納人數</td>
                        <td class="place2_bg"><asp:Label ID="lab_human" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="place1_bg">場地描述</td>
