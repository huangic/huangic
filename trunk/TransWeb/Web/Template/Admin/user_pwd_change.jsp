...
<script language="javascript">
			...
			function checkOnSubmit(){
  			...
  			if( $('htx_oldpassword').value == $('htx_checkpassword').value  ){
  				alert('新舊密碼不可相同');
  				return false;
  			}
...
<div id="FormName">【密碼修改】</div>
<form onSubmit="return checkOnSubmit()" name="reg" method="POST"
	id="Form1" action="user_pwd_save.do">
<table cellspacing="0">
	
	<input class="InputText" type="hidden"
			 name="userinfo.userid" value='<s:property escape="false" value="#session.UserInfo.userInfo.userid"/>'/>
			
	
	<tr>
		<td class="Label" align="right"><span class="Must">*</span>舊密碼</td>
		<td class="whitetablebg"><input class="InputText" type="password"
			id="htx_oldpassword" name="oldPassword" size="20"></td>

	</tr>
	<tr>
		<td class="Label" align="right"><span class="Must">*</span>新密碼</td>
		<td class="whitetablebg"><input class="InputText" type="password"
			id="htx_password" name="userinfo.password" size="20"></td>
	</tr>
	<tr>
 ...
 <input
	class="cbutton" value="存檔" type="submit"><input value="清除重填"
